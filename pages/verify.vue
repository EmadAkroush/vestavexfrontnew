      ...
      <Card class="w-full   shadow-lg cardin" >
        <template #content>
          <div class="flex flex-col items-center justify-center h-full p-6 insidede" >
            ...
            <template v-if="payment?.data?.code == 100">
              ...
              <h6 class="mt-2 text-gray-700">شماره پیگیری: <span class="font-bold">{{ payment?.data?.ref_id }}</span></h6>
                   <div
