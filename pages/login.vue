    ...
    <div class="mainlogin">
      <div class="flex justify-center w-full my-16 pb-16">
        <div class="bg-white sm-p-6 rounded w-full paper">
          ...
          <Tabs value="0">
            <TabList>
              <Tab value="0"> ورود </Tab>
              <Tab value="1"> ثبت نام </Tab>
            </TabList>
              ...
              <TabPanel value="0">
                ...
                <div class="flex items-center gap-4 mt-4">
                  ...
                  <InputText
                    ...
                    v-model="cellphonesms"
                    class="border-gray-300 rounded-full px-4 py-2 w-full"
                  />

                  <!-- PrimeVue Button -->
                  <!-- <Button
                    label="ارسال کد یکبار مصرف"
                    icon="pi pi-key"
                    class="text-white rounded-full sm:px-4 px-0 py-2 w-full cubtn"
                ...
                <div
                  class="flex mb-4 justify-center mt-8"
                  style="direction: ltr"
                >
                  <InputOtp v-model="otpcode" />
                </div>
                ...
                <Button
                  label="ورود ثبت نام با رمز یکبار مصرف"
                  icon="pi pi-sign-in"
